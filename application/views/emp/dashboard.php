...
<style>
  ...
  font-weight: 600;
    ...
    .break-activity-card:hover {
        box-shadow: 0 8px 32px rgba(0, 0, 0, 0.12);
    }

    /* Header */
    .break-activity-header {
        background: linear-gradient(135deg, #e74a3b 0%, #ff6b6b 50%, #ee5a24 100%);
        padding: 20px 24px;
        display: flex;
        align-items: center;
    ...
    /* Custom scrollbar */
    .break-activity-body::-webkit-scrollbar {
        width: 5px;
    }

    .break-activity-body::-webkit-scrollbar-track {
        background: transparent;
    }

    .break-activity-body::-webkit-scrollbar-thumb {
        background: #e2e8f0;
        border-radius: 10px;
    }

    .break-activity-body::-webkit-scrollbar-thumb:hover {
        background: #cbd5e0;
    }
    ...
    .break-item:not(:last-child)::after {
        content: '';
        position: absolute;
        bottom: 0;
        left: 68px;
    ...
    .break-time-badge {
        ...
        align-items: center;
        gap: 6px;
        background: linear-gradient(135deg, #fff5f5, #ffe8e5);
        color: #e74a3b;
        padding: 6px 14px;
        border-radius: 10px;
        font-size: 0.82rem;
...
<div class="card mb-3">
  <div class="card-body">
    <h6 class="text-danger">🎂 Upcoming Birthdays</h6>
...
style="width:40px;height:40px;border-radius:50%;object-fit:cover;">
      ...
      <div class="ms-2">
        ...
        <small><?= date('d M',strtotime($b->dob)) ?></small>
      </div>
...
<div class="card">
  <div class="card-body">
    ...
    <h6 class="text-primary">👨‍💻 Employees </h6>
...
<small class="text-muted"><?= ucfirst($e->designation) ?></small>
      </div>
    ...
    <?php endforeach; ?>
        ...
        <div class="break-activity-card mb-4">

            <!-- Header -->
            <div class="break-activity-header">
                <div class="break-header-left">
                    <div class="break-header-icon">
                        <i class="bx bx-coffee-togo"></i>
                    </div>
                    <div class="break-header-text">
                        <h6>Employee Breaks </h6>
                        <span><i class="bx bx-calendar me-1"></i>Today's Breaks</span>
                    </div>
                </div>

                <?php if (!empty($today_breaks)): ?>
                    <div class="break-count-badge">
                        <span class="live-dot me-1"></span>
                        <?= count($today_breaks) ?> Break<?= count($today_breaks) > 1 ? 's' : '' ?>
                    </div>
                <?php endif; ?>
            </div>

            <!-- Body -->
            <div class="break-activity-body">
                    ...
                    <?php foreach ($today_breaks as $b): ?>
                        <div class="break-item">
                            ...
                            <div class="break-info">
                                <p class="break-name"><?= htmlspecialchars($b->name) ?></p>
                                <span class="break-reason">
                ...
                <?php else: ?>
                    ...
                    <div class="break-empty-state">
                        <div class="break-empty-icon">
                            <i class="bx bx-coffee-togo"></i>
                        </div>
                        <h6>No Breaks Taken Today</h6>
        ...
        <div class="leave-card card mb-3 animate-card">
            <div class="card-header">
                <h5 class="mb-0 text-white">🏠 Employees Status</h5>
            </div>
            <div class="card-body p-0">
