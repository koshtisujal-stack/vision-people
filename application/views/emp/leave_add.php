...
List Employee</a></li>
   ...
   <li>
        ...
        <ul>
            ...
            <li>
                <a href="<?= base_url('emp/attendance/attendance_list') ?>">
...
<li>
    <a href="<?= base_url('emp/leave/list') ?>">Leave List</a>
</li>
        ...
        <div class="col-12 col-md-8 col-lg-6">
                    ...
                    <div class="card shadow-sm mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?= base_url('emp/leave/store') ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="reason" rows="4" class="form-control" placeholder="Enter leave reason..." required></textarea>
                                </div>
