...
<div class="wrapper">
	...
	<div class="sidebar-wrapper" data-simplebar="true">
		<div class="sidebar-header">
			<img src="<?= base_url('assets/images/logo-icon.png') ?>" class="logo-icon">
		...
		<ul class="metismenu" id="menu">
			...
			<li>
				...
				<ul>
					<li><a href="<?= base_url('emp/attendance_add') ?>">Add Attendance</a></li>
					<li><a href="<?= base_url('emp/attendance/attendance_list') ?>">Attendance List</a></li>
				</ul>
			</li>
			...
			<li class="mm-active">
				...
				<ul>
					<!-- <li><a href="<?= base_url('emp/leave/add') ?>">Add Leave</a></li> -->
					<li class="mm-active"><a href="<?= base_url('emp/leavee/list') ?>">Leave List</a></li>
				</ul>
			</li>
		</ul>
	</div>
			...
			<div class="container-fluid px-4 mt-5">
				...
				<div class="card shadow-sm border-0 rounded-3">
					<div class="card-header bg-white border-bottom">
						<h5 class="mb-0 fw-semibold">My Leave List</h5>
					</div>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-hover align-middle">
								...
								<?php if(!empty($leaves)){ $i=1; foreach($leaves as $row){ 
